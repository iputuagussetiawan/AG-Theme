...
/***/ "./src/js/modules/LightBoxVideo.js":
/*!*****************************************!*\
  !*** ./src/js/modules/LightBoxVideo.js ***!
  \*****************************************/
...
var LightBoxVideo = /*#__PURE__*/_createClass(
// 1. describe and create/initiate our object
function LightBoxVideo() {
  _classCallCheck(this, LightBoxVideo);
  this.lightboxVideo = glightbox__WEBPACK_IMPORTED_MODULE_0___default()({
    selector: '.glightboxVideo'
  });
});
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (LightBoxVideo);
...
var Navbar = /*#__PURE__*/function () {
  ...
  _createClass(Navbar, [{
    ...
    value: function events() {
      ...
      this.pageService.addEventListener('click', function (event) {
        event.preventDefault();
        var ourWork = document.querySelector('#work');
        _this.scrollToSection(ourWork);
      });
    }
...
/*!******************************!*\
  ...
  \******************************/
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _modules_LightBoxVideo__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../modules/LightBoxVideo */ "./src/js/modules/LightBoxVideo.js");
...
var scroller = gsap_ScrollSmoother__WEBPACK_IMPORTED_MODULE_4__.ScrollSmoother.create({
  smooth: 1,
...
//2. Declaration
var lightBoxVideo = new _modules_LightBoxVideo__WEBPACK_IMPORTED_MODULE_0__["default"]();
var fadeUp = document.querySelectorAll(".fadeUp");
if (fadeUp) {
  fadeUp.forEach(function (fu) {
    gsap__WEBPACK_IMPORTED_MODULE_2__.gsap.fromTo(fu, {
      y: '20%',
      autoAlpha: 0
    }, {
      duration: 1,
...
function mouseFollow() {
  var locationButton = document.querySelector('.locations-two__button');
  var locationButtonText = document.querySelector('.locations-two__button-text');
  var locationFollowArea = document.querySelectorAll('.card-location');
  var locationPage = document.querySelector('.locations-two__lists');
  function moveCircle(e) {
    gsap__WEBPACK_IMPORTED_MODULE_2__.gsap.to(locationButton, {
      left: e.clientX,
      top: e.clientY,
      duration: 0.25
      // autoAlpha:1,
  ...
  locationFollowArea.forEach(function (el) {
    el.addEventListener('mouseover', function () {
      var nameCard = el.dataset.name;
      var cursorName = document.querySelector(".locations-two__button-text");
    ...
    el.addEventListener('mousedown', function () {
      ...
      gsap__WEBPACK_IMPORTED_MODULE_2__.gsap.to(locationButtonText, {
        css: {
          opacity: 1
        },
        duration: 0.25
...
var sectionWorkTwo = document.querySelector(".work-two");
var workSideTitle = document.querySelector(".work-two__side-title");
if (sectionWorkTwo && workSideTitle) {
  gsap_ScrollTrigger__WEBPACK_IMPORTED_MODULE_3__.ScrollTrigger.create({
    ...
    start: '-300px top',
      ...
      return "+=".concat(sectionWorkTwo.offsetHeight - (workSideTitle.offsetWidth + 300));
    },
    pin: '.work-two__side-title'
  });
}
var sectionLocationTwo = document.querySelector(".locations-two");
var locationSideTitle = document.querySelector(".locations-two__side-title");
if (sectionLocationTwo && locationSideTitle) {
  gsap_ScrollTrigger__WEBPACK_IMPORTED_MODULE_3__.ScrollTrigger.create({
    trigger: '.locations-two__side-title',
    start: '-100px top',
    end: function end() {
      return "+=".concat(sectionLocationTwo.offsetHeight - (locationSideTitle.offsetWidth + 450));
    },
...
var sectionRecruitmentTwo = document.querySelector(".recruitment-two");
var recruitmentSideTitle = document.querySelector(".recruitment-two__side-title");
if (sectionRecruitmentTwo && recruitmentSideTitle) {
  gsap_ScrollTrigger__WEBPACK_IMPORTED_MODULE_3__.ScrollTrigger.create({
    trigger: '.recruitment-two__side-title',
    start: '-150px top',
    end: function end() {
      return "+=".concat(sectionRecruitmentTwo.offsetHeight - (recruitmentSideTitle.offsetWidth + 300));
    },
...
var sectionsSideTitleMobile = gsap__WEBPACK_IMPORTED_MODULE_2__.gsap.utils.toArray('.section-title__side-left--mobile');
sectionsSideTitleMobile.forEach(function (sectionSideTitleMobile) {
  gsap__WEBPACK_IMPORTED_MODULE_2__.gsap.to(sectionSideTitleMobile, {
    xPercent: -150,
    ease: "none",
    scrollTrigger: {
...
var sectionsSideTitleRightMobile = gsap__WEBPACK_IMPORTED_MODULE_2__.gsap.utils.toArray('.section-title__side-right--mobile');
sectionsSideTitleRightMobile.forEach(function (sectionSideTitleRightMobile) {
  gsap__WEBPACK_IMPORTED_MODULE_2__.gsap.to(sectionSideTitleRightMobile, {
    xPercent: -150,
    ease: "none",
    scrollTrigger: {
...
function artsenDesktop() {
  scroller.effects(".section-title__side-left", {
    speed: 1.3
  });
  scroller.effects(".section-title__side-right", {
    speed: 1.3
  });
}
...
gsap__WEBPACK_IMPORTED_MODULE_2__.gsap.utils.toArray(".image-parallax").forEach(function (container) {
...
var sections = gsap__WEBPACK_IMPORTED_MODULE_2__.gsap.utils.toArray('.section-overlap');
...
var scrollToBottom = document.querySelector('.banner-three__scroll-bottom');
var scrollToBottomTarget = document.querySelector('.ourbusiness-two');
