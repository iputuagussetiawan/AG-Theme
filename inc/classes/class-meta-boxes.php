...
class Meta_Boxes {
	...
	public function add_custom_meta_box() {
		...
		foreach ( $screens as $screen ) {
			add_meta_box(
				...
				__( 'Hide page title', 'ag-theme' ),  // Box title
	...
	public function custom_meta_box_html( $post ) {
		...
		?>
		<label for="agtheme-field"><?php esc_html_e( 'Hide the page title', 'ag-theme' ); ?></label>
		<select name="agtheme_hide_title_field" id="agtheme-field" class="postbox">
			<option value=""><?php esc_html_e( 'Select', 'ag-theme' ); ?></option>
			<option value="yes" <?php selected( $value, 'yes' ); ?>>
				<?php esc_html_e( 'Yes', 'ag-theme' ); ?>
			</option>
			<option value="no" <?php selected( $value, 'no' ); ?>>
				<?php esc_html_e( 'No', 'ag-theme' ); ?>
			</option>
		</select>
		<?php
	}
	...
	public function save_post_meta_data( $post_id ) {
		...
		if ( array_key_exists( 'agtheme_hide_title_field', $_POST ) ) {
			update_post_meta(
				$post_id,
				'_hide_page_title',
				$_POST['agtheme_hide_title_field']
			);
		}
	}
